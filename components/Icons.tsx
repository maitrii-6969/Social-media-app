...
export const HeartIcon = ({ className, solid = false }: { className?: string, solid?: boolean }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill={solid ? "currentColor" : "none"} viewBox="0 0 24 24" stroke="currentColor">
